...
export class MultiProviderMarketDataService {
  ...
  private constructor() {
    ...
    // SECURITY: Resolve API keys from environment only - no hardcoded defaults
    const CMC_KEY_1 = getAPIKey('coinmarketcap', 'marketData') || process.env.CMC_API_KEY || process.env.COINMARKETCAP_API_KEY || '';
