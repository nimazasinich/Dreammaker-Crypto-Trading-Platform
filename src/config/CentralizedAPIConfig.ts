  ...
  blockExplorers: {
    ethereum: {
      primary: {
        ...
        key: '', // SECURITY: Load from env - ETHERSCAN_API_KEY or Etherscan
        method: 'GET',
        needsProxy: false,
      ...
      fallbacks: [
        {
          name: 'etherscan_2',
          baseUrl: 'https://api.etherscan.io/api',
          key: '', // SECURITY: Load from env - ETHERSCAN_BACKUP_API_KEY or Etherscan_2
          method: 'GET',
          needsProxy: false,
          rateLimit: { requests: 5, interval: 1000 },
          enabled: true
    ...
    bsc: {
      primary: {
        ...
        key: '', // SECURITY: Load from env - BSCSCAN_API_KEY or BscScan
        method: 'GET',
        needsProxy: false,
        rateLimit: { requests: 5, interval: 1000 },
        enabled: true,
    ...
    tron: {
      primary: {
        ...
        key: '', // SECURITY: Load from env - TRONSCAN_API_KEY or TronScan
        method: 'GET',
        needsProxy: false,
    ...
    fallbacks: [
      {
        ...
        key: '', // SECURITY: Load from env - CMC_API_KEY or COINMARKETCAP_API_KEY
      ...
      },
      {
        ...
        baseUrl: 'https://pro-api.coinmarketcap.com/v1',
        key: '', // SECURITY: Load from env - CMC_API_KEY_2 or COINMARKETCAP_API_KEY_2
        headerKey: 'X-CMC_PRO_API_KEY',
        method: 'GET',
        needsProxy: true,
        rateLimit: { requests: 5, interval: 1000 },
      ...
      },
      {
        ...
        key: '', // SECURITY: Load from env - CRYPTOCOMPARE_API_KEY
        method: 'GET',
        needsProxy: false,
    ...
    fallbacks: [
      {
        ...
        key: '', // SECURITY: Load from env - NEWS_API_KEY or NEWSAPI_KEY
        headerKey: 'X-API-Key',
        method: 'GET',
        needsProxy: true,
