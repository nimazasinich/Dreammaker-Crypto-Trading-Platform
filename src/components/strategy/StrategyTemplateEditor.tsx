      ...
      `}</style>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                                ...
                                {Object.values(STRATEGY_TEMPLATES).map((template) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full p-3 rounded-lg transition-all duration-200 ${isSelected ? 'ring-2 ring-offset-2 ring-offset-slate-900' : 'hover:bg-white/5'
                                                }`}
                                            style={{
                    ...
                    <div className="xl:col-span-2 space-y-4">
                        {/* Actions */}
                        <div className="rounded-xl p-3 backdrop-blur-sm flex flex-wrap items-center justify-between gap-2"
                            style={{
                                background: 'linear-gradient(135deg, rgba(15, 15, 24, 0.95) 0%, rgba(20, 20, 30, 0.95) 100%)',
                        ...
                        >
                            <h3 className="text-lg font-bold text-white mb-3">Strategy Parameters</h3>
                                    ...
                                    <div key={key} className="p-3 rounded-lg bg-white/5 border border-white/10">
                                        ...
                                        {typeof param.value === 'boolean' ? (
                                            <button
                                                ...
                                                className={`w-full py-2 rounded-lg font-semibold transition-all ${param.value
                        ...
                        >
                            <h3 className="text-lg font-bold text-white mb-3">Risk Management</h3>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                <h3 className="text-base font-bold text-emerald-400 mb-3">Entry Conditions</h3>
                            ...
                            >
                                <h3 className="text-base font-bold text-rose-400 mb-3">Exit Conditions</h3>
                                <ul className="space-y-2">
